...
# Disable LLM guardrails during ablation — ablated summaries are intentionally
# incomplete and would be blocked by the input guardrail
os.environ["ENABLE_INPUT_LLM_GUARDRAIL"] = "false"
os.environ["ENABLE_OUTPUT_LLM_GUARDRAIL"] = "false"
